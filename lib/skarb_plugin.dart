...
import 'package:skarb_plugin/performance_log.dart';
...
class SkarbPlugin {
  ...
  static Future<String?> getReceiptBase64() async {
    return _measure('getReceiptBase64', () async {
  ...
  static Future<String?> getSkarbDeviceId() async {
    return _measure('getSkarbDeviceId', () async {
      if (Platform.isAndroid) {
  ...
  static Future<String?> getCountryCode() async {
    return _measure('getCountryCode', () async {
      if (Platform.isIOS) {
        try {
  ...
  static Future<String?> observeUnconsumedOneTimePurchases() async {
    return _measure('observeUnconsumedOneTimePurchases', () async {
      if (Platform.isAndroid) {
  ...
  static Future<String?> sendAFSource(
    ...
    return _measure('sendAFSource', () async {
  ...
  static Future<String?> sendTest(String? name, String? group) async {
    return _measure('sendTest', () async {
      if (Platform.isAndroid) {
        await _methodChannel
  ...
  static Future<bool> isPremium() async {
    return _measure('isPremium', () async {
      if (Platform.isAndroid) {
        try {
    ...
    return _measure('fetchUserPurchasesInfo', () async {
      ...
      if (Platform.isAndroid) {
        ...
        if (result is String) {
          ...
          try {
            return SkarbPurchaseInfo.fromJson(
  ...
  static Future<void> loadOfferings({
    ...
    return _measure('loadOfferings', () async {
      if (Platform.isAndroid) {
        try {
  ...
  static Future<SkarbPurchaseResult> purchasePackage(String packageName) async {
    return await _measure('purchasePackage', () async {
      logger?.logEvent(
        eventType: SkarbEventType.info,
  ...
  static void _logPerformance({
    ...
    final logData = PerformanceLog(method: method, duration: duration);

    logger?.logEvent(
      eventType: SkarbEventType.performance,
      message: logData.toJsonString(),
    );
  }
}
